...
public class Borrar_Acetres extends javax.swing.JInternalFrame {

    public Borrar_Acetres() {
        initComponents();
        try {
            Connection cn = Conexion.conectar("VasoSagrado", "sa", "sasa");
            PreparedStatement ps=cn.prepareStatement("select * from Acetres");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Connection cn = Conexion.conectar("VasoSagrado", "sa", "sasa");
            CallableStatement cs = cn.prepareCall("{Call Borrar_Acetre(?,?)}");
