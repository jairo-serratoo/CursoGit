...
public class Actualizar_Pass extends javax.swing.JInternalFrame {

    public Actualizar_Pass() {
        initComponents();
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
          try {
            ...
            CallableStatement cs = cn.prepareCall("{Call Cam_Pass(?,?,?,?)}");
            ...
            if( jPasswordField2.getText() == null ? jPasswordField3.getText() != null : !jPasswordField2.getText().equals(jPasswordField3.getText()))
            {
                ...
                JOptionPane.showMessageDialog(this, "El nuevo Password no coincide");
            }
            else
            {
                cs.setString(3, jPasswordField3.getText());
            }
