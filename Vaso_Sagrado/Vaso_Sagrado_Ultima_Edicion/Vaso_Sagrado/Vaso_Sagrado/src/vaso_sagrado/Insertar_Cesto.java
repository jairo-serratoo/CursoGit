...
public class Insertar_Cesto extends javax.swing.JInternalFrame {

    public Insertar_Cesto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "100", "250", "500", "1000", " " }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            CallableStatement cs = cn.prepareCall("{Call Alta_Cestos(?,?,?,?,?,?)}");
            ...
            cs.setInt(5, Integer.parseInt(jFormattedTextField3.getText()));
