...
public class Asignar_Tareas extends javax.swing.JInternalFrame {
    ...
    public Asignar_Tareas() {
        initComponents();
          try {
            ...
            Connection c1 = Conexion.conectar("VasoSagrado", "sa", "sasa");
            PreparedStatement ps1=c1.prepareStatement("select * from Producto");
            ...
            while(rs1.next())
            {
                this.jComboBox2.addItem(rs1.getString("Nombre_Class_Producto"));
            }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Pieza a Elaborar ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection cn = Conexion.conectar("VasoSagrado", "sa", "sasa");
            CallableStatement cs = cn.prepareCall("{Call Alta_Trabajo(?,?,?,?)}");
            cs.setString(1, jComboBox1.getSelectedItem().toString());
            cs.setString(2,jComboBox2.getSelectedItem().toString());
            cs.setString(3,jTextArea1.getText());
