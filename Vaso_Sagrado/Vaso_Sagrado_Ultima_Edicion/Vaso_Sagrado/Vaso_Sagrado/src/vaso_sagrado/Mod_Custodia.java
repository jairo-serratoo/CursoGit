...
public class Mod_Custodia extends javax.swing.JInternalFrame {
    ...
    public Mod_Custodia() {
        ...
        try {
            ...
            PreparedStatement ps=c.prepareStatement("select * from Custodias");
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30", "45", "60", "90", "120", "180", "200" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            CallableStatement cs = cn.prepareCall("{Call Actualizar_Custodia(?,?,?,?,?)}");
