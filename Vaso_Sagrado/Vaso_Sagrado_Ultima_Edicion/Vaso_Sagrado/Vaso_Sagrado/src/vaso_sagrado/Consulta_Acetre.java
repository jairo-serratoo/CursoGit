...
public class Consulta_Acetre extends javax.swing.JInternalFrame {
String ar1[]={"Nombre","Capacidad","Coste","Existencia"};
String ar2[][]=new String [4][1];
    public Consulta_Acetre() {
        initComponents();
        ar2=llenarArreglo2();
     ...
     public String[][] llenarArreglo2(){
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from Acetres");
            if(rs.last());
            int filas=rs.getRow();
            ...
            for(int i = 0; i< temp.length; i++){
                ...
                temp[i][1]=rs.getString("Cap_Almac_Litros");
